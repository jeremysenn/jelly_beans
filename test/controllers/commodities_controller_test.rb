...
class CommoditiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commodity" do
    assert_difference('Commodity.count') do
      post commodities_url, params: { commodity: { active: @commodity.active, description: @commodity.description, name: @commodity.name, price: @commodity.price, type: @commodity.type, unit_of_measure: @commodity.unit_of_measure } }
    end
  ...
  test "should update commodity" do
    patch commodity_url(@commodity), params: { commodity: { active: @commodity.active, description: @commodity.description, name: @commodity.name, price: @commodity.price, type: @commodity.type, unit_of_measure: @commodity.unit_of_measure } }
